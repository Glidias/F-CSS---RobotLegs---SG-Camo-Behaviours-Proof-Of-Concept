...
package com.gaiaframework.core
{
	...
	public class GaiaImpl implements IGaia
	{
		...
		{
			GaiaDebug.log("Gaia Framework (AS3) v3.2.0");
		}
		
		public function getAssetLoader():IAssetLoader {
		...
		public function setPreloaderInstance(preloader:IPreloader = null):void
		{
			SiteController.getPreloader().preloaderInstance = preloader;
		}
		...
		public function setAssetPreloaderInstance(preloader:IPreloader = null):void
		{
			AssetLoader.instance.preloaderInstance = preloader;
		}
