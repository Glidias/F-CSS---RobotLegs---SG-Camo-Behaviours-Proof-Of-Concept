...
package com.gaiaframework.assets
{
	...
	import sg.camogxmlgaia.assets.display.DisplayRenderAsset;
	import sg.camogxmlgaia.assets.display.DisplayRenderSourceAsset;
	import sg.camogxmlgaia.assets.display.GXMLRenderAsset;
	import sg.camogxmlgaia.assets.property.PropertySheetAsset;
	import sg.camogxmlgaia.assets.domain.BehavioursDomainAsset;
	import sg.camogxmlgaia.assets.domain.DefinitionsDomainAsset;
	...
	public class AssetTypes
	{
		...
		gaia_internal static function init():void
		{
			...
			add(DisplayRenderAsset, "displayRender");
			add(DisplayRenderSourceAsset, "displayRenderSource");
			add(GXMLRenderAsset, "gxmlPage");
			add(GXMLRenderAsset, "gxml");
			add(PropertySheetAsset, "propertySheet");
			add(BehavioursDomainAsset, "behaviours");
			add(DefinitionsDomainAsset, "definitions");
